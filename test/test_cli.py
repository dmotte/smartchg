...
def test_save_data() -> None:
    ...
    csv = '\n'.join((
        headers_line,
        '2020-08-13,0.00,116.080,116.080,0.000,119.612,115.329,117.471,'
        '-0.6494',
        '2020-09-13,31.00,118.450,117.023,1.427,120.555,116.273,118.414,'
        '0.0168',
        '2020-10-13,61.00,118.620,117.944,0.676,121.476,117.193,119.334,'
        '-0.3336',
        '2020-11-13,92.00,121.340,118.902,2.438,122.434,118.152,120.293,'
        '0.4889',
        '2020-12-13,122.00,122.250,119.838,2.412,123.370,119.087,121.228,'
        '0.4772',
        '2021-01-05,145.00,125.000,120.559,4.441,124.091,119.808,121.950,'
        '1.4243',
    )) + '\n'
